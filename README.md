...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="navbar">
        <a class="navbar-brand" href="#Home"> <img id="logo" src="assets/img/moya.png" alt="" />
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <div class="navbar-nav ml-auto ">
                ...
                <a class="btn btn-outline-success my-2 my-sm-0 " id="navbarButtons" href="tel:713-992-0916">
        ...
        <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <h2 class="text-white-50 mx-auto mt-2 mb-5">Üretim, Pazarlama ve Satış</h2>
                </div>
            </div>
        </header>
    </section>
    ...
    <section class=" projects-section bg-light" id="products">
        <div class="container">
            <h1>Ürünlerimiz</h1>
            <!-- Project One Row-->
            <div class="row justify-content-center no-gutters c">
                <div class="col-lg-6"><img class="img-fluid" src="assets/img/4.jpg" alt="" /></div>
                <div class="col-lg-6">
                    <div class="bg-black text-center h-100 project">
                        <div class="d-flex h-100">
                            <div class="project-text w-100 my-auto text-center text-lg-left">
                                <h4 class="text-white">Mast Kazı</h4>
                                <p class="mb-0 text-white-50">Mast kazı Almanya’da hem et, hem yumurta, hem yemden
                                    ...
                                    ay ve yaşlarda 10-11 KG a kadar artmaktadır.</p>
            ...
            <div class="row justify-content-center no-gutters ">
                <div class="col-lg-6"><img class="img-fluid" src="assets/img/9.jpg" alt="" /></div>
            ...
            <div class="row justify-content-center no-gutters ">
                <div class="col-lg-6"><img class="img-fluid" src="assets/img/11.jpg" alt="" /></div>
                <div class="col-lg-6">
                    <div class="bg-black text-center h-100 project">
                        <div class="d-flex h-100">
                            <div class="project-text w-100 my-auto text-center text-lg-left">
                                <h4 class="text-white">Mast Kazı Civcivi</h4>
                                <p class="mb-0 text-white-50">Mast kazı civcivleri yaklaşık olarak 90 günde 5-6
                                    kilograma kadar ulaşabilirler.</p>
                                <hr class="d-none d-lg-block mb-0 ml-0 colorer" />
            ...
            <!-- Project Two Row-->
            <div class="row justify-content-center no-gutters">
                <div class="col-lg-6"><img class="img-fluid" src="assets/img/8.jpg" alt="" /></div>
                <div class="col-lg-6 order-lg-first">
                    <div class="bg-black text-center h-100 project">
                        <div class="d-flex h-100">
                            <div class="project-text w-100 my-auto text-center text-lg-right">
                                <h4 class="text-white">Mast Kazı Yumurtası</h4>
                                <p class="mb-0 text-white-50">Mast kazı yumurtası, en çok protein içeren yumurta
                                    türlerinden birisidir. Yaklaşık olarak 100gr'da 14gr protein bulunmaktadır. </p>
                                <hr class="d-none d-lg-block mb-0 mr-0" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
                <div class="col-lg-6"><img class="img-fluid" src="assets/img/meat.jpg" alt="" /></div>
                <div class="col-lg-6">
                    <div class="bg-black text-center h-100 project">
                        <div class="d-flex h-100">
                            <div class="project-text w-100 my-auto text-center text-lg-left">
                                <h4 class="text-white">Mast Kazı Eti</h4>
                                <p class="mb-0 text-white-50">Kazı eti, tavuk gibi diğer kümes hayvanlarından daha
                                    lezzetlidir. Göürünüm ve lezzet olarak kırmızı ete daha yakındır. </p>
                                <hr class="d-none d-lg-block mb-0 ml-0" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card py-4 h-100">
                        <div class="card-body text-center">
                            ...
                            <hr class="my-4" />
                            <div class="medium text-black-50">Görükle / BURSA</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card py-4 h-100">
                        <div class="card-body text-center">
                            ...
                            <hr class="my-4" />
                            <div class="medium text-black-50">moyakaz@ciftligi.com</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card py-4 h-100">
                        <div class="card-body text-center">
                            ...
                            <hr class="my-4" />
                            <div class="medium text-black-50">+90 (555) 444 33 22</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="footer bg-black small text-center text-white-50">
        <div class="container">Copyright © Moya Kaz 2020</div>
    </footer>
    <!-- Bootstrap core JS-->
